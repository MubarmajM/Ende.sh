...
def input_color(prompt, color):
    ...
    if color == "red":
        ...
        return input(f"\033[1;34m{prompt}\033[0m")
    elif color == "yellow":
        return input(f"\033[1;33m{prompt}\033[0m")
    elif color == "purple":
        return input(f"\033[38;5;129m{prompt}\033[0m")  # Purple using ANSI escape code
    elif color == "orange":
        return input(f"\033[38;5;208m{prompt}\033[0m")  # Orange using ANSI escape code
    elif color == "gray":
        return input(f"\033[38;5;245m{prompt}\033[0m")  # Gray using ANSI escape code
    elif color == "pink":
        return input(f"\033[1;35m{prompt}\033[0m")
    elif color == "cyan":
